...
/**
 * Test case for class Tx_T3o_snippets_Controller_SnippetController.
 *
 * @version $Id$
 ...
 */
class Tx_T3o_snippets_Controller_SnippetControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
